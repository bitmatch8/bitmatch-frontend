            ...
            <div className="etch-formBox">
                <div className="etch-formItemBox">
                    ...
                    <div className="etch-inputBox1">
                        <input type="text" placeholder="12 letter identifier like ”ABCDE·FGHI”" onBlur={setRuneName} />
                    </div>
                ...
                <div className="etch-formItemBox">
                    ...
                    <div className="etch-inputBox1">
                        <input type="text" placeholder="21000000" onBlur={setPremineAmount} />
                    </div>
                    ...
                    <div className="etch-formItemBox etch-formTtemBox2">
                        <div className="etch-formItemInner">
                            <div className="etch-formItemBox">
                                ...
                                <div className="etch-inputBox1">
                                    <input type="text" placeholder="21000000" onBlur={setPublicAmount} />
                                </div>
                                <p className="etch-formErrorTip"></p>
                            </div>
                        </div>
                        <div className="etch-formItemInner">
                            <div className="etch-formItemBox">
                                ...
                                <div className="etch-inputBox1">
                                    <input type="text" placeholder="2100" onBlur={setMintAmount} />
                                </div>
                                <p className="etch-formErrorTip"></p>
                            </div>
                        </div>
